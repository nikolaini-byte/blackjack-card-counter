...
async def list_counting_systems():
    ...
    return {
        "counting_systems": [
            ...
            {"id": "hiOptI", "name": "Hi-Opt I", "description": "Balanced, level 1 system"},
            {"id": "hiOptII", "name": "Hi-Opt II", "description": "Balanced, level 2 system"},
            {"id": "ko", "name": "KO (Knock-Out)", "description": "Unbalanced system"},
            {"id": "omegaII", "name": "Omega II", "description": "Balanced, level 2 system"},
            {"id": "zenCount", "name": "Zen Count", "description": "Balanced, level 2 system"}
        ]
    }
