...
def manage_bankroll(
    bankroll_request: BankrollRequest,
) -> Union[BankrollRecommendation, Dict[str, str]]:
    """
    ...
    kelly_bet = _calculate_kelly_bet(
        bankroll_request.bankroll, bankroll_request.true_count
    )
    ...
    risk_of_ruin = _calculate_risk_of_ruin(
        bankroll_request.bankroll, recommended_bet, bankroll_request.true_count
    )

    # Calculate expected value
    expected_value = _calculate_expected_value(
        recommended_bet, bankroll_request.true_count
    )
...
def _calculate_risk_of_ruin(
    bankroll: Currency, bet_size: Currency, true_count: TrueCount
) -> Probability:
    """
